...
export default defineConfig({
  ...
  routes: [
    ...
    { path: '/login', component: '@/pages/Login/Login.tsx', title: '登录' },
    {
      ...
      title: '鲁辩 赛程安排',
      wrappers: ['@/pages/wrappers/auth.tsx'],
    },
    {
      path: '/team',
      component: '@/pages/teams/index',
      title: '鲁辩 队伍筛选',
      wrappers: ['@/pages/wrappers/auth.tsx'],
    },
    {
      path: '/personnel',
      component: '@/pages/personnel/index',
      title: '鲁辩 对阵',
      wrappers: ['@/pages/wrappers/auth.tsx'],
    },
    {
    ...
    {
      path: '/m-back',
      component: '@/pages/backmobile/Mobile',
      title: '鲁辩 赛果(备用)',
      wrappers: ['@/pages/wrappers/auth.tsx'],
    },
    {
      path: '/back',
      component: '@/pages/BackDetail/index',
      title: '鲁辩 赛果单(备用)',
      wrappers: ['@/pages/wrappers/auth.tsx'],
    },
    {
      path: '/vj/questionnaire',
      component: '@/pages/results/questionnaire/index',
      title: '赛果收集',
    },
    {
      path: '/vj/success',
      component: '@/pages/results/success/success.tsx',
      title: '提交成功',
    },
  ],
  fastRefresh: {},
