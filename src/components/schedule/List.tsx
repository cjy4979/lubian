...
export default class List extends Component<any, any>  {
  ...
  buildCode = () => {
    ...
    //全白
    var url0 = "https://new.bianlun.online/#/show?rid=27826&nub=false&useb=true&off=false&ringBellTime=30&isDisplayTitle=true&custom=true&water=false&color=true&colorCode=%23ffffff%7C%23ffffff%7C%23ffffff%7C%23ffffff%7C%23ffffff%7C%23BF2727%7C%2390cf5b" +
  ...
  render() {
    ...
    var greetings = ""+((hours<12)?"上午好":(hours>=12 && hours<19)?"下午好":"晚上好")

    //给评委发的赛事提醒
    var saishiCopy = "各位前辈" + greetings +"～非常感谢各位前辈执评鲁辩决赛的比赛。\n"+
    "本场赛事信息如下：\n"+ 
    "时间："+ time + 
    "\n对阵："+this.state.z+" vs "+this.state.f+
    "\n辩题："+this.state.topic+
    "\n腾讯会议号："+this.state.meeting+
        ...
        <div className={styles.firstRow}>
          ...
          >
            {this.state.check === true ?
              //红标，禁止修改状态
              <svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2302" width="32" height="32"><path d="M504.109851 16.453128c-278.332339 0-503.966321 225.632974-503.966321 503.966321S225.776505 1024.384762 504.109851 1024.384762s503.966321-225.632974 503.966321-503.966321S782.44219 16.453128 504.109851 16.453128zM242.706054 566.655409l0.04734-94.679771 525.432441 0-0.017123 94.679771L242.706054 566.655409z" p-id="2303" fill="#d81e06"></path></svg>
              :
              //绿标，开启修改
              <svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3552" width="34" height="34"><path d="M852.8 261.6l2.3 1.2-2.3-1.2z" fill="#68BB8D" p-id="3553"></path><path d="M514.2 99.9c-228.5 0-413.7 185.2-413.7 413.7s185.2 413.7 413.7 413.7S927.8 742 927.8 513.5 742.5 99.9 514.2 99.9zM712 430.7L553 587l-77 75.3c-0.3 0.4-0.7 0.8-1.2 1.3-0.6 0.6-1.3 1.2-2 1.8-4.8 4.6-11.1 7.1-17.8 7.1h-1.1c-7 0-13.5-2.6-18.3-7.4-0.7-0.6-1.3-1.2-1.9-1.7-0.4-0.4-0.7-0.7-1-1.1L304.3 533.9c-10.4-10.4-9.7-28 1.5-39.2 5.7-5.7 13.3-8.9 21-8.9 7 0 13.5 2.6 18.3 7.4l109.4 109.4 58.1-56.8 159.1-156.3c4.8-4.7 11.2-7.2 18.1-7.2 7.8 0 15.5 3.3 21.2 9.1 11 11.4 11.6 29 1 39.3z" fill="#68BB8D" p-id="3554"></path></svg>
          ...
          <div className={styles.firstRowRight}>
            <Input className={styles.meeting} id='meeting'
              ...
              style={this.state.rights === '1' ? { width: 190 } : { width: 210 }}
              onChange={(e, v) => this.onInputChange(v)} />
            {
              this.state.rights === '1' ?
                <Paragraph copyable={{ content: saishiCopy }} >
                </Paragraph>
                :
                ''
            }
