...
export default function index() {
  ...
  useEffect(() => {
    ...
    if (getCookie('rights') !== '1') {
      ...
      fetch('/api/getteamlist?selected=0')
  ...
  const fresh = () => {
    ...
    //拒绝的队伍
    fetch('/api/getteamlist?selected=2')
      .then((response) => response.json())
      .then((data) => {
        var leftList = data.data.map((item: any) => {
          return {
    ...
    //待定的队伍
    fetch('/api/getteamlist?selected=3')
      .then((response) => response.json())
      .then((data) => {
        var leftList = data.data.map((item: any) => {
          return {
  ...
  const onClick = (data: any) => {
    ...
    if (
      ...
      fetch('/api/getlistbyteam?team=' + data.itemKey)
        .then((response) => response.json())
        .then((data) => {
    ...
    <div style={{ height: '100hv' }}>
      ...
      <div className={styles.main}>
        ...
        <div className={styles.right_content}>
          {key === 'add' ? <AddTeam /> : <ShowTeam {...teamData} />}
        </div>
      </div>
    </div>
  );
...
export function PassIcon() {
  return (
    ...
    >
      <path
        d="M768 192H640c0-70.4-57.6-128-128-128s-128 57.6-128 128H256c-35.2 0-64 28.8-64 64v640c0 35.2 28.8 64 64 64h512c35.2 0 64-28.8 64-64V256c0-35.2-28.8-64-64-64z m-256-32c17.6 0 32 14.4 32 32s-14.4 32-32 32-32-14.4-32-32 14.4-32 32-32z m256 736H256V256h64v64h384v-64h64v640z m-59.2-404.8L459.2 740l-45.6-45.6 248.8-248.8 46.4 45.6z m-340 68l136 136-45.6 45.6-136-136 45.6-45.6z"
        p-id="4994"
      ></path>
    </svg>
  );
...
export function UnhandleIcon() {
  return (
    ...
    >
      <path
        d="M293.432889 853.333333H91.022222V170.666667h841.955556v439.182222h-52.337778v-386.844445H143.36v577.991112h150.072889V853.333333z"
        fill="#e6e6e6"
        p-id="5290"
      ></path>
      <path
        d="M227.555556 375.466667h568.888888v52.337777H227.555556zM227.555556 558.535111h568.888888v52.337778H227.555556z"
        fill="#e6e6e6"
        p-id="5291"
      ></path>
      <path
        d="M876.088889 796.444444m-56.888889 0a56.888889 56.888889 0 1 0 113.777778 0 56.888889 56.888889 0 1 0-113.777778 0Z"
        fill="#e6e6e6"
        p-id="5292"
      ></path>
      <path
        d="M443.733333 796.444444m-56.888889 0a56.888889 56.888889 0 1 0 113.777778 0 56.888889 56.888889 0 1 0-113.777778 0Z"
        fill="#e6e6e6"
        p-id="5293"
      ></path>
      <path
        d="M659.911111 796.444444m-56.888889 0a56.888889 56.888889 0 1 0 113.777778 0 56.888889 56.888889 0 1 0-113.777778 0Z"
        fill="#e6e6e6"
        p-id="5294"
      ></path>
    </svg>
